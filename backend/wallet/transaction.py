...
from backend.config import MINING_REWARD, MINING_REWARD, MINING_REWARD_INPUT

class Transaction:
    """
    Document of an exchange in currency from
    ...
    def create_input(self, sender_wallet, output):
        ...
        Sign the transaction and include the sender's
