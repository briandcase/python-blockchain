...
class Wallet:
    ...
    Allows a miner to authroize transactions.
    """
    ...
    def calculate_balance(blockchain, address):
        ...
        The balance is found by adding the output values that belong
        to the address since the most recent transaction by that address.
